...
output "cluster_id" {
  ...
  value       = awscc_parallelcluster_cluster.hpc.id
}

output "cluster_name" {
  description = "Name of the created ParallelCluster"
  value       = awscc_parallelcluster_cluster.hpc.cluster_name
}

output "head_node_public_ip" {
  description = "Public IP address of the head node"
  value       = awscc_parallelcluster_cluster.hpc.head_node_public_ip
}
...
output "cluster_endpoint" {
  ...
  value       = awscc_parallelcluster_cluster.hpc.endpoint
} 